...
public class CanVusApps {
    public static void main(String[] args) throws InterruptedException {
        ...
        driver.findElement(By.id("user_name")).sendKeys("Alex Komanov");
        driver.findElement(By.cssSelector("[id=\"user_email\"]")).sendKeys("test@gmail.com");
        driver.findElement(By.cssSelector("#user_password")).sendKeys("123456");
